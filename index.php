...
<<<<<<< HEAD
            <form action="http://localhost/employee-management/php-employee-management-v1/src/library/loginController.php" method="POST">
=======
...
>>>>>>> Z
                ...
                <h1 class="h3 mb-3 fw-normal">Log into your account</h1>
                ...
                <div class="mt-5">
                    ...
                    <p class="mt-5 mb-3 text-muted">&copy; ZZ & MM</p>
                </div>
            </form>
        </main>
