    ...
    let data = fetch("../resources/employees.json") // cambiar la url a employee controller
        ...
        .then(jsondata => {
            for(let e = 0;e<jsondata.length;e++){
                ...
                employRow.innerHTML = `<div type="button" class="container d-flex justify-content-between border-bottom mt-2 pb-2">
                ...
                <div class="col text-start fs-4">${employees[e].phoneNumber}</div>
