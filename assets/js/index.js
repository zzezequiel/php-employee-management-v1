...
function renderEmployees(employees) {
    ...
    */
    ...
    for (let e = 0; e < employees.length; e++) {
        ...
        employRow.innerHTML = `<div type="button" class="container row border-bottom mt-2 pb-2" id="${employees[e].id}">
                    ...
                    <div class="col text-end  delete pt-2" id="del${id}" type="button" data-bs-toggle="modal" data-bs-target="#modal${id}">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="button" id="delete${id}" data-bs-dismiss="modal" class="btn btn-primary">Delete</button>
                          </div>
                        </div>
                      </div>
                    </div> `;
        chargeEventListeners(id);
        employeeDetail(id);
        
                     
    } //closure render for loop
 ...
 function chargeEventListeners(id) {  //deleteEventlisteners charge
    let launchDeleteModal = document.getElementById(`delete${id}`);
...
function employeeDetail(id){
    employeeInfo = document.getElementById(`${id}`);  //add dinamic id to buttons//add dinamic id to buttons  `${employees[e].id}`
